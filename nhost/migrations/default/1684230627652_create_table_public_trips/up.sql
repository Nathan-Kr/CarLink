...
CREATE OR REPLACE FUNCTION public.get_nearby_trips(trip_row trips, startlat double precision, startlong double precision, endlat double precision, endlong double precision, bound integer, departure_date date)
 RETURNS SETOF trips
 LANGUAGE sql
 STABLE
AS $function$
